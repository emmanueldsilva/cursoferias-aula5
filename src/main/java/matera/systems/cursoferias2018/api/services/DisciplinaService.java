...
public class DisciplinaService {
	...
	private static final Predicate<? super UsuarioEntity> USUARIOS_PROFESSORES = u -> "PROFESSOR".equals(u.getPerfil());
    ...
    private Function<DisciplinaEntity, DisciplinaResponse> toResponse = (entity) -> {
        ...
        response.setProfessores(getProfessoresIds(entity));
	...
	private List<String> getProfessoresIds(DisciplinaEntity entity) {
		return entity.getUsuarios()
					.stream()
					.filter(USUARIOS_PROFESSORES)
