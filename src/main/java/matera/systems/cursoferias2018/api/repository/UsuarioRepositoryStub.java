    ...
    static {
        {
            ...
            entity.setUrlFoto("http://bucket/usuario/1/perfil.png");
...

        {
            ...
            entity.setSenha("senha");
            entity.setUrlFoto("http://bucket/usuario/2/perfil.png");
...

        {
            ...
            entity.setPerfil("USUARIO");
            entity.setSenha("senha");
            entity.setUrlFoto("http://bucket/usuario/3/perfil.png");
