    ...
    public void adicionaPresenca() {
        ...
        Response response =
                RestAssured
                    ...
                    .when()
                        .put(API + VERSION + FREQUENCIA_URL + "/" + DisciplinasRepositoryStub.DISCIPLINA_1.toString()
        ...
        Response response =
                RestAssured
                    .given()
                        ...
                        .header(CONTENT_TYPE_HEADER, "application/json")
                    .when()
                        .delete(API + VERSION + FREQUENCIA_URL + "/" + DisciplinasRepositoryStub.DISCIPLINA_1.toString()
                                + "/"  +  UsuarioRepositoryStub.USUARIO_1.toString())
                    .thenReturn();
